...
const Register = ({ setAlert, registe, isAuthenticated }) => {                // destructure setAlert from props
    ...
    const onSubmit = async e => {
        ...
        if(password !== password2) {
            setAlert('passwords do not match', 'danger');       // call setAlert action if passwords don't match. send (message, alertType) see actions/alert.js
        } else {
